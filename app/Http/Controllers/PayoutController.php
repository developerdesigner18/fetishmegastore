...
class PayoutController extends Controller
{
    ...
    public function withdraw(Request $request)
    {
        ...
        $paxumDetails = user_meta('paxum_email');
        $cryptoAddress = user_meta('crypto_address');
        $payoutSettings = ['destination' => $payoutDestination, 'details' => $payoutDetails,'paxumDetails' => $paxumDetails,'cryptoAddress' => $cryptoAddress];
    ...
    public function saveSettings(Request $request)
    {
        ...
        $request->validate(['payout_destination' => 'required', 'payout_details' => 'required' ,'paxumDetails' => 'required']);

        set_user_meta('payout_destination', $request->payout_destination);
        set_user_meta('payout_details', $request->payout_details);
        set_user_meta('paxum_email', $request->paxumDetails);
        set_user_meta('crypto_address', $request->cryptoAddress);
