...
<div class="proceed-to-pay">
    <div class="pay-section">
        ...
        <h3 class="mt-5 text-2xl font-semibold dark:text-white text-center">
            <?php echo e(__('You are purchasing :tokensAmount tokens for :moneyAmount', [
        ...
        <div class="mt-5 justify-center mx-auto text-center">
            <form action="<?php echo e($paypalUrl); ?>" method="POST" id="paypalForm">
                <input type="hidden" name="business" value="<?php echo e($paypalEmail); ?>">
                <input type="hidden" name="return" value="<?php echo e($redirectURL); ?>">
                <input type="hidden" name="cancel_return" value="<?php echo e(route('token.packages')); ?>">
                <input type="hidden" name="notify_url" value="<?php echo e(route('paypal.ipn')); ?>">
                <input type="hidden" name="currency_code" value="<?php echo e($currencyCode); ?>">
                <input type="hidden" name="amount" value="<?php echo e($sale->amount); ?>">
                <input type="hidden" name="item_name" value="<?php echo e($sale->tokens); ?> tokens">
                <input type="hidden" name="custom" value="<?php echo e($sale->id); ?>">
                ...
                <div id="loader-overlay" style="display:none;">
                    <div class="loader-container">
                        <img src="<?php echo e(asset('images/loader.gif')); ?>" alt="Loading..." class="spinner">
                        <p>Please wait...</p>
                    </div>
                </div>
            </form>
    ...
    <div class="w-75 proceed-img">
        <img src="<?php echo e(asset('images/2050291934669e45796c22d.jpg')); ?>" />
    </div>
</div>
<script>
...
<?php /**PATH /var/www/vhosts/fetishmegastore.com/httpdocs/resources/views/paypal.blade.php ENDPATH**/ ?>