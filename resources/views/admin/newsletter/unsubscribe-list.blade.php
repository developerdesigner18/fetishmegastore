            ...
            <tr>
               ...
               <x-td>
                ...
                <select class="action-select border rounded text-sm"
                        data-user-id="{{ $u->id }}"
                        data-current-value="{{ $u->is_subscribe }}"
                        data-url="{{ route('admin.userSubscriptionStatus') }}">

                    <option disabled selected>{{ $u->is_subscribe == 1 ? 'subscribe' : 'Unsubscribe' }}</option>
