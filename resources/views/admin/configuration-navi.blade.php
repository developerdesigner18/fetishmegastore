<div class="bg-white rounded p-3 my-5 text-gray-200">
    ...
    |
    <a href="/admin/configuration/video-settings"
        class="text-lg ml-2 text-indigo-600 hover:text-indigo-500 font-semibold @if(isset($active) && $active == 'video-settings') underline @endif">
        {{ __('Video Settings') }}
    </a>
     <a href="/admin/configuration/unsubscribe-reasons"
        class="text-lg ml-2 text-indigo-600 hover:text-indigo-500 font-semibold @if(isset($active) && $active == 'unsubscribe-reasons') underline @endif">
        {{ __('Unsubscribe Reasons') }}
    </a>
</div>