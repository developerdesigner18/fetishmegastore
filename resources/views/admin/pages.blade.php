                ...
                <dl>
                    ...
                    <dd>
                        <input type="text" name="page_title"
                               class="w-full px-2 py-2 rounded-md shadow-sm border-2 outline-indigo-500 text-gray-700 font-bold border-gray-200"
                               required="required"
...
{{--                    <dd>--}}
{{--                        <input type="text" name="from_i_talk"--}}
{{--                               class="w-full px-2 py-2 rounded-md shadow-sm border-2 outline-indigo-500 text-gray-700 font-bold border-gray-200"--}}
{{--                               required="required"--}}
{{--                               value="{{ old('from_i_talk') }}"/>--}}
{{--                    </dd>--}}
{{--                    <br>--}}
