    ...
    <div class="bg-white rounded p-3">
        <form method="POST">
            ...
            <dl>
                ...
                <br>
{{--                <dt>{{ __('From I Talk')  }}</dt>--}}
{{--                <dd>--}}
{{--                    <input type="text" name="from_i_talk" class="w-full px-2 py-2 rounded-md shadow-sm border-2 outline-indigo-500 text-gray-700 font-bold border-gray-200" value="{{ $p->from_i_talk ?? "" }}" />--}}
{{--                </dd>--}}
{{--                <br>--}}
