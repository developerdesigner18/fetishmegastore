...
@section('section_body')
    ...
    <div>
        <a href="{{route('blog.add.view')}}"><x-button>Add Blog</x-button></a>
            ...
            @foreach ($blogs as $c)
                <tr>
                    ...
                    <x-td>
                        ...
                        <div class="btn-group">
                            <a class="inline-flex mr-2" href="{{route('blog.edit.view',['id' => $c->id])}}">
                                <i class="fa-solid fa-pencil text-teal-600"></i>
                            </a>
                            <a href="{{route('blog.delete',['id' => $c->id])}}"
                               onclick="return confirm('{{ __('Are you sure you want to remove this Blog from database?')  }}');"
                               class="inline-flex">
