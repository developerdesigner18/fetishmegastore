<table width="100%" cellpadding="0" cellspacing="0" role="presentation"
            ...
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tr>
                    <td style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';padding:25px 0;text-align:center">
                        <a href="https://fetishmegastore.com"
                           ...
                           target="_blank"
                           data-saferedirecturl="https://www.google.com/url?q=https://fetishmegastore.com&amp;source=gmail&amp;ust=1713341447008000&amp;usg=AOvVaw0QQPLesijtypOVA7cfWRAe">
                            FetishMegaStore
                        </a>
                    </td>
                </tr>
                ...
                <tr>
                    <td width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <table class="m_2106377268054126046inner-body" align="center" width="570" cellpadding="0"
                            ...
                            <tr>
                                <td style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';max-width:100vw;padding:32px">
                                    <p style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">Congratulations, You just subscribe tier
                                        {{$subscription->tier->tier_name}} for {{$subscription->subscription_tokens}}</p>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                                                            <a href="#"
                                                               class="m_2106377268054126046button" rel="noopener"
    ...
    <tr>
        <td style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
            <table class="m_2106377268054126046footer" align="center" width="570" cellpadding="0" cellspacing="0"
                   role="presentation"
                ...
                <tr>
                    <td align="center"
                        ...
                        <p style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';line-height:1.5em;margin-top:0;color:#b0adc5;font-size:12px;text-align:center">
                            © 2024 {{env('APP_NAME')}}. All rights reserved.</p>
