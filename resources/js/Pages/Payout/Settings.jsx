...
export default function Settings({ payoutSettings }) {
    ...
    const { data, setData, post, processing, errors, reset } = useForm({
        ...
        paxumDetails: payoutSettings.paxumDetails ?? "",
        cryptoAddress: payoutSettings.cryptoAddress ?? "",
    });
            ...
            <div className="mt-3 max-w-sm">
                <form onSubmit={submit}>
                    <div className="mt-4">
                        ...
                        {data.payout_destination == "paxumDetails" && (
                            <>
                                <InputLabel
                                    forInput="paxumDetails"
                                    className="mt-3"
                                    value="Paxum Email"
                                />

                                <Textarea
                                    value={data.paxumDetails}
                                    name="paxumDetails"
                                    className="w-full"
                                    handleChange={(e) =>
                                        setData(
                        ...
                        {data.payout_destination == "cryptoAddress" && (
                            <>
                                <InputLabel
                                    forInput="cryptoAddress"
                                    className="mt-3"
