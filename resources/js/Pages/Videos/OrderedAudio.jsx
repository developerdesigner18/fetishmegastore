...
import AudiosLoop from "./Partials/AudiosLoop";
import AccountNavi from "../Channel/Partials/AccountNavi";

export default function AudioOrdered({ audio }) {
    ...
    const searchAudio = (e) => {
        ...
        console.log(
            `Would visit: ${route("audio.ordered")}?search_term=${searchTerm}`
        );
        Inertia.visit(`${route("audio.ordered")}?search_term=${searchTerm}`, {
            method: "GET",
            preserveState: true,
            only: audio,
        });
    ...
    return (
        <AuthenticatedLayout>
            <Head title={__("Purchased Audio")} />

            <div className="lg:flex lg:space-x-10">
                <AccountNavi active={"Audio"} />
