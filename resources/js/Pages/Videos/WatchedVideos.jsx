...
export default function VideosOrdered({videos, userLoginID}) {
                ...
                <div className="ml-0 w-full">
                    {auth.user.is_streamer == "yes" && (
                        <div className="mb-5">
                            ...
                            <Link href={route("affiliate")} className={inactiveTabClass}>
                            {__("Affiliate")}
                            </Link> 

                            <Link href={route("commission")} className={inactiveTabClass}>
                                {__("Commission")}
                            </Link> 
                        </div>
                    )}
                    ...
                    <div className="p-4 sm:p-8 bg-white dark:bg-zinc-900 shadow sm:rounded-lg">
                        ...
                        {videos.total !== 0 && (
                            <div className="">
                                ...
                                {/*                        <a href={v.videoUrl} download>{__("Download")}</a>*/}
                                {/*                    </span>*/}
                                {/*                </div>*/}
                                {/*            </div>*/}
                                {/*        </div>*/}
