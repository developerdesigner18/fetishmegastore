...
export default function BrowseAudio({
    ...
    const doRequest = () => {
        if (currentPage != page && sort) {
            ...
            Inertia.visit(
                ...
                {
                    only: ["audio", "randomaudio", "recommendedAudio"],
                    preserveState: true,
    ...
    const onChangePaginate = (pageNumber) => {
        ...
        let fullPath = audio.path + '?page=' + pageNumber;
    ...
    return (
        <Front
            ...
            extraHeader={true}
            extraHeaderTitle={__("Browse Audio")}
        ...
        >
            ...
            <div className="flex w-full -mt-16">
                <form onSubmit={submit}>
                    ...
                    >
                        ...
                        <SecondaryButton
                            className="mt-2"
                            onClick={(e) =>
                                Inertia.visit(route("audio.browse"))
                            }
                        >
                            {__("Reset")}
                        </SecondaryButton>
                ...
                <div className="flex-grow">
                    ...
                    {audio.current_page == 1 && randomaudio.total > 0 && (
                        <div>
                            <h2 className="text-indigo-700 text-2xl font-bold dark:text-white">
                                {__("Random Audio")}
                            </h2>
                            <AudioLoop audio={randomaudio.data} blocks={blocks} />
                    ...
                    <AudioLoop audio={audio.data} blocks={blocks} />
                    ...
                    {recommendedAudio.data.length > 0 && (
                        <>
                            <h2 className="text-indigo-700 text-2xl font-bold dark:text-white">
                                {__("Recommended Audio")}
                            </h2>
                            <AudioLoop audio={recommendedAudio.data} blocks={blocks} />
                        </>
                    )}
                    ...
                    {audio.last_page > 1 && (
                        <>
                            ...
                            {/*/>*/}
                            <Pagination
                                total={audio.last_page * 10}
                                defaultCurrent={audio.current_page}
