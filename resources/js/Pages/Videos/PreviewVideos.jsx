...
export default function Upload({ videos }) {
    ...
    const deleteVideo = () => {
        Inertia.visit(route("preview.delete"), {
            method: "POST",
            data: { video: deleteId },
            preserveState: false,
        });
    ...
    return (
        <AuthenticatedLayout>
            ...
            >
                <div className="px-5 py-10 text-center">
                    <h3 className="text-xl mb-3 text-zinc-700 dark:text-white">
                        {__("Are you sure you want to remove this preview?")}
                    </h3>
            ...
            <div className="lg:flex lg:space-x-10">
                <AccountNavi active={"preview-videos"} />
                <div className="ml-0">
                    <Link
                    ...
                    <div className="mt-5 p-4 sm:p-8 bg-white dark:bg-zinc-900 shadow sm:rounded-lg">
                        <header>
                            ...
                            <p className="mt-1 mb-2 text-sm text-gray-600 dark:text-gray-400">
                                {__("Upload & manage Preview for the channel")}
                            </p>

                            <PrimaryButton
                                onClick={(e) =>
                                    Inertia.visit(route("preview.upload"))
                                }
                            >
                                {__("Upload Preview")}
                            </PrimaryButton>
                        ...
                        {videos.total === 0 && (
                            <div className="text-gray-600 dark:text-white">
                                {__("You didn't upload any previews yet.")}
                            </div>
                        )}
