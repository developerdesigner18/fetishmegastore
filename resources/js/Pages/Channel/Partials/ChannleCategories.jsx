...
export default function ChannleCategories({ streamUser }) {
    const [channels, setVideos] = useState({});
    ...
    return (
        <div className="mt-5">
            ...
            <CategoryLoop channels={channels.data}/>
            ...
            {channels.total === 0 && (
                <div className="dark:text-white dark:bg-zinc-900 rounded-lg px-3 py-5 text-gray-600 bg-white shadow">
                    {__("No categories uploaded by :streamer", {
