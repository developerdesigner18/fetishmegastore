...
use App\Http\Controllers\PromoToolsController;
...
// Route::get('cache-clear', function () {
    ...
    // echo 'success', 'Successfully cache cleared.';
    // return redirect()->back();
// })->name('cache.clear');

// Test routes for updating views
Route::get('/update-audio-views', [TestController::class, 'updateAudioViews']);
Route::get('/update-gallery-views', [TestController::class, 'updateGalleryViews']);
Route::get('/update-short-video-views', [TestController::class, 'updateShortVideoViews']);
Route::get('/update-video-views', [TestController::class, 'updateVideoViews']);
...
Route::group(
    [
        ...
        'middleware' => ['localeSessionRedirect', 'localizationRedirect', 'localeViewPath', \App\Http\Middleware\LanguageManager::class]
    ],
    function () {

        Route::get('/browse-videos/filter', [VideosController::class, 'filterVideos'])->name('videos.filter');

        Route::get('/audio/{audio}/download', [VideosController::class, 'downloadAudio'])->middleware('auth')->name('audio.download');

        //Route::get('/', [HomeController::class, 'index'])->name('home');
        //Route::get('/', [VideosController::class, 'browse'])->name('home');
        Route::get('/', [VideosController::class, 'browseVideos'])->name('home');
        ...
        Route::get('faqs', [FaqController::class, 'index'])->name('web.faq.index');
        ...
        Route::get('/channel/{user}/categories', [ChannelController::class, 'channelCategories'])->name('channel.categories');
        Route::get('/channel/{user}/tags', [ChannelController::class, 'channelTags'])->name('channel.tags');
        Route::get('/channel/{user}/previews', [ChannelController::class, 'channelPreviews'])->name('channel.previews');
        Route::get('/channel/{user}/galleries', [ChannelController::class, 'channelGalleries'])->name('channel.galleries');
        ...
        // Videos
        Route::get('/browse-videos/{videocategory?}{slug?}', [VideosController::class, 'browseVideos'])->name('videos.browse');
        ...
        Route::get('/single-video/{id}', [VideosController::class, 'singleVideoPage'])->name('video.single.page');

        //new route
        Route::post('/video/{video}/purchase', [VideosController::class, 'linkPurchaseVideo'])->middleware('auth')->name('video.linkPurchase');
        ...
        Route::post('/video/increase-short-views/{shortVideo}', [ShortVideoController::class, 'increaseViews'])->name('video.increaseShortViews');
        ...
        //new route  start
        Route::get('/my-watched-videos', [VideosController::class, 'myWatchedVideos'])->name('watchedVideos.list');

        Route::get('/affiliate', [AffiliateController::class, 'affiliate'])->name('affiliate');
        Route::post('/affiliate-request', [AffiliateController::class, 'requestAffiliateVendor'])->name('affiliate.submit');

        //Route::get('/promo-banner', [PromoToolsController::class, 'affiliateDashboard'])->name('promo-banner');

        //Route::post('/affiliate-request', [PromoToolsController::class, 'requestAffiliateVendor'])->name('affiliate.submit');
        //end new route

        Route::post('/track-video-view/{slug}', [VideosController::class, 'trackUnauthWatchedVideo']);
        ...
        Route::put('/update-video/{video}', [VideosController::class, 'updateVideo'])->name('videos.update');
        Route::post('video/save', [VideosController::class, 'save'])->name('videos.save');
        ...
        Route::post('/audio/purchase/{audio}', [VideosController::class, 'purchaseAudio'])->name('audio.purchase');
        ...
        //Route::get('/upload-audio', [VideosController::class, 'uploadAudio'])->name('audio.upload');
        Route::post('/audio/increase-audio-views/{audio}', [VideosController::class, 'increaseAudioViews'])->name('audio.increaseAudioViews');
        ...
        Route::get('/preview-edit/{video}', [VideosController::class, 'previewEdit'])->name('preview.edit');
        Route::post('/preview-update/{video}', [VideosController::class, 'previewUpdate'])->name('preview.update');
        ...
        Route::get('/gallery-edit/{video}', [VideosController::class, 'galleryEdit'])->name('gallery.edit');
        Route::post('/gallery-update/{video}', [VideosController::class, 'galleryUpdate'])->name('gallery.update');
        ...
        //start new route
        Route::get('affiliate-program', [AffiliateProgramController::class, 'index'])->name('web.affiliate.affiliateProgram');

        // Route::get('/affiliate-dashboard', [AffiliateController::class, 'affiliateDashboard'])->name('affiliateDashboard');

        Route::get('/affiliate-dashboard/commission', [AffiliateController::class, 'affiliateCommission'])->name('affiliateDashboard');
        Route::get('/affiliate-dashboard/tracking', [AffiliateController::class, 'affiliateTracking'])->name('affiliate.dashboard.tracking');
        Route::get('/affiliate-dashboard/banner', [AffiliateController::class, 'affiliatePromoBanner'])->name('affiliate.dashboard.banner');
        Route::get('/affiliate-dashboard/videos', [AffiliateController::class, 'affiliatePromoVideos'])->name('affiliate.dashboard.videos');
        Route::get('/affiliate-dashboard/gallery', [AffiliateController::class, 'affiliatePromoGallery'])->name('affiliate.dashboard.gallery');

        Route::get('/affiliate-dashboard/affiliate-guide', [AffiliateController::class, 'affiliateGuide'])->name('affiliateGuide');

        Route::get('/affiliate-dashboard/affiliate-account', [AffiliateController::class, 'affiliateAccount'])->name('affiliateAccount');
        Route::post('/affiliate-dashboard/affiliate-account/save', [AffiliateController::class, 'saveAffiliateAccount'])->name('affiliateAccount.save');

        Route::get('/affiliate-dashboard/withdrawal', [AffiliateController::class, 'withdrawal'])->name('withdrawalCommission');
        Route::post('/affiliate-dashboard/withdrawal-request', [AffiliateController::class, 'withdrawalRequest'])->name('withdrawal.request');

        Route::get('/promo-videos-page', [PromoToolsController::class, 'promoVideo'])->name('promo-videos');

        Route::get('/new-promo-single-page/{id}', [AffiliateController::class, 'newPromoSinglePage'])->name('singlePage.promo');

        Route::get('/gallery-promo-single-page/{id}', [AffiliateController::class, 'galleryPromoSinglePage'])->name('gallerySinglePage.promo');

        //add blogs
        // Route::get('/blogs-manager', [VideosController::class, 'blogsManager'])->name('blogs.list');
        // Route::get('/add-blogs', [VideosController::class, 'addBlogs'])->name('blogs.upload');
        // Route::post('/blogs-save', [VideosController::class, 'blogSave'])->name('blogs.save');
        // Route::post('/blogs-delete', [VideosController::class, 'blogsDelete'])->name('blogs.delete');
        // Route::get('/blogs-edit/{video}', [VideosController::class, 'blogsEdit'])->name('blogs.edit');
        // Route::post('/blogs-update/{video}', [VideosController::class, 'blogsUpdate'])->name('blogs.update');

        Route::get('/blogs-manager', [VideosController::class, 'blogsManager'])->name('blogs.list');
        Route::get('/blogs/upload', [VideosController::class, 'addBlogs'])->name('blogs.upload');
        Route::post('/blogs/save', [VideosController::class, 'blogSave'])->name('blogs.save');
        Route::get('/blogs/{id}/edit', [VideosController::class, 'blogsEdit'])->name('blogs.edit');
        Route::put('/blogs/{blog}', [VideosController::class, 'blogsUpdate'])->name('blogs.update');
        Route::post('/blogs/delete', [VideosController::class, 'blogsDelete'])->name('blogs.delete');

        Route::get('/user-guide', [VideosController::class, 'displayUserGuidePage'])->name('page.userAccount');
        //End new route

        Route::get('/email-unsubscribe/{id}', [HomeController::class, 'emailUnsubscribeUser'])->name('emailUnsubscribeUser');
        Route::post('/email-unsubscribe/{id}', [HomeController::class, 'submitUnsubscribeUser'])->name('submitEmailUnsubscribeUser');

        // start E-book route
        Route::get('/ebook-manager', [EbookController::class, 'ebookManager'])->name('ebook.list');
        Route::get('/browse-ebook/{videocategory?}{slug?}', [EbookController::class, 'browseEbook'])->name('ebook.browse');
        Route::get('/single-ebook/{id}', [EbookController::class, 'singleEbookPage'])->name('ebook.single.page');
        Route::get('/ebook/{ebook}-{slug}', [EbookController::class, 'audioPage'])->name('ebook.page');
        Route::get('/channel/{user}/ebook', [EbookController::class, 'channelAudio'])->name('channel.ebook');
        Route::get('/ebook/unlock/{ebook}', [EbookController::class, 'unlockEbook'])->name('ebook.unlock');
        Route::post('/ebook/purchase/{ebook}', [EbookController::class, 'purchaseEbook'])->name('ebook.purchase');
        // End ebook route

        //E-book Route 
        Route::get('/edit-ebook/{ebook}', [EbookController::class, 'editEbook'])->name('ebook.edit');
        Route::post('/update-ebook/{ebook}', [EbookController::class, 'updateEbook'])->name('ebook.update');
        Route::post('/save-ebook', [EbookController::class, 'saveEbook'])->name('ebook.saveEbook');
        Route::post('/delete-ebook', [EbookController::class, 'deleteEbook'])->name('ebook.delete');
        Route::get('/upload-ebook', [EbookController::class, 'uploadEbook'])->name('ebook.upload');
        Route::post('/ebook/increase-ebook-views/{ebook}', [EbookController::class, 'increaseEbookViews'])->name('ebook.increaseEbookViews');

        Route::get('/ebook/{ebook}/stream', [EbookController::class, 'streamEbook'])->name('ebook.stream');
        Route::get('/ebook/{ebook}/download', [EbookController::class, 'downloadEbook'])->name('ebook.download');

        // Users Purchased E-book Routes
        // Route::get('/browse-audio/{videocategory?}{slug?}', [VideosController::class, 'browseAudio'])->name('audio.browse');
        // Route::get('/single-audio/{id}', [VideosController::class, 'singleAudioPage'])->name('audio.single.page');
        Route::get('/my-ebook', [EbookController::class, 'MyEbook'])->name('ebook.ordered');
        // Route::get('/audio/{audio}-{slug}', [VideosController::class, 'audioPage'])->name('audio.page');
        Route::get('/channel/{user}/ebook', [ChannelController::class, 'channelEbook'])->name('channel.ebook');
        // Route::get('/audio/unlock/{audio}', [VideosController::class, 'unlockAudio'])->name('audio.unlock');
        // Route::post('/audio/purchase/{audio}', [VideosController::class, 'purchaseAudio'])->name('audio.purchase');

        
        // Products Routes
        Route::get('/browse-products/{videocategory?}{slug?}', [ProductsManagementController::class, 'index'])->name('products.index');
        Route::get('/video/{video}-{slug}', [VideosController::class, 'videoPage'])->name('video.page');
