...
Route::post('upload-audio-chunks', [VideosController::class, 'uploadChunkedAudio'])->name('audio.uploadChunks');
Route::post('upload-ebook-chunks', [VideosController::class, 'uploadChunkedEbook'])->name('ebook.uploadChunks');
Route::post('upload-textFile-chunks', [TextFileController::class, 'uploadChunkedTextFile'])->name('textFile.uploadChunks');
