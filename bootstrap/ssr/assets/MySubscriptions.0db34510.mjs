...
import { MdOutlineSubscriptions } from "react-icons/md/index.js";
          ...
          children: [/* @__PURE__ */ jsx("header", {
            children: /* @__PURE__ */ jsxs("div", {
              ...
              children: [/* @__PURE__ */ jsx("div", {
                children: /* @__PURE__ */ jsx(MdOutlineSubscriptions, {
                  className: "w-8 text-gray-600 h-8 dark:text-white"
                })
              }), /* @__PURE__ */ jsxs("div", {
                children: [/* @__PURE__ */ jsxs("h2", {
                  className: "text-lg md:text-xl font-medium text-gray-600 dark:text-gray-100",
                  children: [__("My Subscriptions"), " (", subs.total, ")"]
                }), /* @__PURE__ */ jsx("p", {
                  className: "mt-1 mb-2 text-sm text-gray-600 dark:text-gray-400",
                  children: __("These are the channels you are subscribed to")
                })]
              })]
            })
          }), /* @__PURE__ */ jsx("hr", {
            ...
            children: [/* @__PURE__ */ jsx(FiUserMinus, {
              ...
              children: __("You haven't subscribed to any channel.")
            })]
          }), /* @__PURE__ */ jsx("div", {
            ...
            children: [/* @__PURE__ */ jsx("hr", {
              ...
              className: "flex text-gray-600 dark:text-gray-100 my-3 text-sm",
