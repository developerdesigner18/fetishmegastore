...
function Subscribe({
  ...
  const updatePlan = (plan2) => {
    ...
    switch (plan2) {
      case "6 Months":
        console.log(`Setting plan to ${plan2} and price to ${tier.SixMonthsPrice}`);
        setShowPrice(tier.SixMonthsPrice);
        break;
      case "Monthly":
        console.log(`Setting plan to ${plan2} and price to ${tier.price}`);
        setShowPrice(tier.price);
        break;
      case "Yearly":
        console.log(`Setting plan to ${plan2} and price to ${tier.YearlyPrice}`);
  ...
  const confirmSubscription = (e) => {
    e.preventDefault();
    Inertia.visit(route("confirm-subscription", {
      user: channel.id,
      tier: tier.id,
      plan
    }), {
        ...
        children: [/* @__PURE__ */ jsxs("header", {
          children: [/* @__PURE__ */ jsxs("div", {
            ...
            children: [/* @__PURE__ */ jsx("div", {
              ...
              children: [/* @__PURE__ */ jsx(Link, {
                ...
                children: /* @__PURE__ */ jsx("h2", {
                  ...
                  children: __("Subscribe to @:channel", {
                    channel: channel.username
                  })
                })
              }), /* @__PURE__ */ jsx("p", {
                className: "mt-1 text-sm text-gray-600 dark:text-gray-400 text-center",
                children: __("Select subscription length & payment method")
              })]
            })]
          }), /* @__PURE__ */ jsxs("div", {
            className: "flex flex-col md:flex-row md:justify-around items-center mt-10 space-y-5 md:space-y-0",
            children: [/* @__PURE__ */ jsxs("button", {
              ...
              children: [/* @__PURE__ */ jsx("div", {
                className: "absolute inline-flex items-center justify-center px-1.5 py-1 text-xs font-bold text-white bg-pink-500 rounded-full -top-2 right-0",
                children: __(":discount% OFF", {
          ...
          children: [/* @__PURE__ */ jsxs("p", {
            ...
            children: showPrice <= auth.user.tokens ? /* @__PURE__ */ jsxs(Fragment, {
              children: [/* @__PURE__ */ jsxs("button", {
              ...
              children: [__("You need to charge your token balance for this plan"), /* @__PURE__ */ jsx("br", {}), /* @__PURE__ */ jsxs(Link, {
